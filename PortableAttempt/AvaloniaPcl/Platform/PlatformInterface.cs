...
namespace Avalonia.Platform
{
    ...
    /// </summary>
    public abstract class PlatformInterface : IPlatformInterface
    {
        public static IPlatformFactory PlatformFactory { get; set; }

        /// <summary>
        /// The platform factory instance.
        /// </summary>
        private static IPlatformInterface instance;
        ...
        public static IPlatformInterface Instance
        {
            get
            {
                if (instance == null)
                {
                    instance = PlatformFactory.CreatePlatformInterface();
                    return instance;
                }
