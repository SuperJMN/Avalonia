...
<DataTemplate xmlns=""https://github.com/grokys/Avalonia""
    ...
    <TextBlock Text=""{Binding " + this.DisplayMemberPath + @"}"" />
        ...
        public static ItemsControl GetItemsOwner(DependencyObject element)
        {
            ...
            {
                ItemsPresenter itemsPresenter = Media.VisualTreeHelper.GetParent(panel) as ItemsPresenter;
        ...
        public override void OnApplyTemplate()
        {
            ItemsPresenter itemsPresenter =
                Media.VisualTreeHelper.GetDescendents<ItemsPresenter>(this).FirstOrDefault();
