...
namespace Avalonia.Threading
{
    ...
    public sealed class Dispatcher
    {
        ...
        private static Dictionary<IThread, Dispatcher> dispatchers = new Dictionary<IThread, Dispatcher>();

        private static object olock = new object();

        private static DispatcherFrame mainExecutionFrame = new DispatcherFrame();

        private IThread baseIThread;
        ...
        public static Dispatcher CurrentDispatcher
        {
            get
            {
                lock (olock)
                {
                    var t = ServiceLocator.ThreadService.CurrentUIThread;
        ...
        public static Dispatcher FromThread(IThread thread)
        {
            Dispatcher dis;
        ...
        {
            return ServiceLocator.ThreadService.CurrentUIThread == this.baseIThread;
        }

        [EditorBrowsable(EditorBrowsableState.Never)]
        public void VerifyAccess()
        {
            if (ServiceLocator.ThreadService.CurrentUIThread != this.baseIThread)
            {
