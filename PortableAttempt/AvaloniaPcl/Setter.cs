...
namespace Avalonia
{
    // TODO PORT: [XamlSetTypeConverter("ReceiveTypeConverter")]
    public class Setter : SetterBase, ISupportInitialize
    {
        ...
        private object ConvertValue(object value)
        {
            ...
            else if (value is string && this.Property.PropertyType.GetTypeInfo().IsEnum)
            {
            ...
            else
            {
                TypeConverterAttribute attribute =
                    this.Property.PropertyType.GetTypeInfo().GetCustomAttributes(typeof(TypeConverterAttribute), true)
                ...
                if (attribute != null)
                {
                    ...
                    ITypeConverter converter = (ITypeConverter)Activator.CreateInstance(converterType);
