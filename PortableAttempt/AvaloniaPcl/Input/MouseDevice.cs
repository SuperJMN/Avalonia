    ...
    public abstract class MouseDevice : InputDevice, IDisposable
    {
        ...
        public Point GetPosition(IInputElement relativeTo)
        {
            ...
            if (v != null)
            {
                ...
                foreach (Visual ancestor in Media.VisualTreeHelper.GetAncestors(v).OfType<Visual>())
                {
        ...
        private IEnumerable<UIElement> ElementAndAncestors(IInputElement mouseOver)
        {
            ...
            if (mo != null)
            {
                ...
                foreach (UIElement e in Media.VisualTreeHelper.GetAncestors(mo).OfType<UIElement>())
                {
                    yield return e;
                }
            }
